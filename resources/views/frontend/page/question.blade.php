...
@section('ldjson')
        @include('frontend.page.includes.ld_json_question')
@endsection
                    ...
                    <div class="accordion" id="accordionExample">
                            ...
                            <div class="card-header" id="headingTwo">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        dlaczego zapach nie jest tylko z naturalnych składników?
                                    </button>
                                </h2>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                                <div class="card-body">
                                    dla wód złożonych z naturalnych składników, zmętnienie jest zupełnie naturalne. mogą wytrącać się osady i drobne cząstki. nie ma to jednak wpływu na zapach.
                                </div>
                            </div>
                        </div>
                        <!--
